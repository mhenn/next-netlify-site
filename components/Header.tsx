...
export default function Header() {
    return (
        <div className="z-20 flex flex-row justify-between bg-indigo-900 bg-opacity-70 text-white font-bold h-20 w-full fixed">
            <div className="w-1/6 flex justify-end">
                <div className=" my-auto text-2xl">Startup</div>
            </div>
